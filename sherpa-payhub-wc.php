...
Text Domain:		sherpa
GitHub Plugin URI:	https://github.com/agims/sherpa-payhub-wc
GitHub Branch:		master
*/


add_action('plugins_loaded', 'sherpa_woocommerce_payhub_init', 0);

function sherpa_woocommerce_payhub_init() {
        	...
        	?>
				...
				<fieldset class="form-horizontal">
					<div class="form-group">
						<label for="card_number" class="col-md-6 col-sm-8 control-label">
					...
					<div class="form-group">
						<label for="cc_exp_month" class="col-md-6 col-sm-8 control-label">
					...
					<div class="form-group">
						<label for="card_cvv" class="col-md-6 col-sm-8 control-label">
...
function sherpa_woocommerce_add_payhub_gateway( $methods ) {
	$methods[] = 'WC_PayHub_Gateway';
	return $methods;
}

add_filter('woocommerce_payment_gateways', 'sherpa_woocommerce_add_payhub_gateway');